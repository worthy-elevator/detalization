...
<div class="container">
  <div class="container-left">
    ...
    <div class="service-img">
      <img src="/img/13.jpg" alt="Шлифовальная обработка"></div>
    <p class="service-text"><? include'services/13/desc.php';?><br></p>
    <p class="fnk-crm">Наша команда работает в городе Симферополе. Так же возможна доставка по Крыму.</p>
    <div class="services-img" style="<?include ('./services/13/fuckinoff.php');?>margin: 50 0">
    <?
$folder = "services/13/";
...
foreach($services as $key=>$name)
{
  $alt= str_replace("~"," ",$name);
          ...
          input+label #'.$key.'
          {
            background-image: url(/services/13/'.$key.');
          }
          </style>
<div class="pics" style="margin:10 15 10 5">
      <div class="image"><input id="'.$key.'1" type="checkbox"><label for="'.$key.'1" onclick="showImg('.$key.')" style="background-image: url(/services/13/'.$name.');"><img class="fullimg" src="/services/13/'.$name.'" alt="'.$alt.'" id="'.$key.'" style="height:120px;"></label></div>
    </div>
          ';
 }
}
